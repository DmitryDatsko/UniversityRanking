...
public class DbInitializer : IDbInitializer
{
    ...
    public void Initialize()
    {
        ...
        if (!_context.AcademicReputations.Any())
        {
            _context.AcademicReputations.Add(new AcademicReputation
            {
        ...
        if (!_context.EmployerReputations.Any())
        {
            _context.EmployerReputations.Add(new EmployerReputation
            {
        ...
        if (!_context.Citations.Any())
        {
            _context.Citations.Add(new Citation()
            {
                CitationCount = 1578,
        ...
        if (!_context.EmploymentResults.Any())
        {
            _context.EmploymentResults.Add(new EmploymentResult()
            {
        ...
        if (!_context.FacultyStudentRatios.Any())
        {
            _context.FacultyStudentRatios.Add(new FacultyStudentRatio
            {
                Degree = "Bachelor",
        ...
        if (!_context.InternationalTeachersRatios.Any())
        {
            _context.InternationalTeachersRatios.Add(new InternationalTeachersRatio
            {
        ...
        if (!_context.ForeignStudentRatios.Any())
        {
            _context.ForeignStudentRatios.Add(new ForeignStudentRatio
            {
        ...
        if (!_context.ResearchNetworks.Any())
        {
        ...
        if (!_context.StudentStability.Any())
        {
            _context.StudentStability.Add(new StudentStability()
            {
                CountryName = "Ukraine",
                TotalStudents = 7684,
                StudentsMoved = 2500,
